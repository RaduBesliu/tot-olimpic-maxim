...
// Solution: Perform a BFS on every component of the graph. If we find an edge between 2 nodes marked with the same color,
// the graph is not bipartite.

class Solution {
public:
    bool colorGraph(int& n, int& start, list < int >* adjList) {
